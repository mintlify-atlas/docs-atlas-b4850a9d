...
<CardGroup cols={2}>
  ...
  <Card title="Wine & Linux Support" icon="wine-glass" href="/guides/installing-games">
    Run Windows-only Epic titles on Linux and macOS using Wine or CrossOver, with per-game WINE prefix configuration.
  </Card>
  <Card title="EGL Sync" icon="rotate" href="/commands/overview">
  ...
  <Card title="EOS Overlay" icon="layer-group" href="/commands/overview">
  ...
  <Card title="Third-Party Activation" icon="gamepad" href="/commands/overview">
