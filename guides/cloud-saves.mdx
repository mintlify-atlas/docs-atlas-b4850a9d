---
title: "Sync Cloud Saves with Epic Games Cloud"
sidebarTitle: "Cloud Saves"
description: "Upload and download save games to the Epic cloud using Legendary. Sync all games at once or manage saves for individual titles."
---
...
**Accept the auto-detected path without prompting:**

```bash
legendary sync-saves --accept-path <App Name>
```
