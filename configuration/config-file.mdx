---
title: "Legendary Configuration File Reference"
sidebarTitle: "Config File"
description: "Configure Legendary's global settings, per-game options, environment variables, and macOS preferences using the config.ini file."
---
...
<CardGroup cols={3}>
  <Card title="Environment Variables" icon="terminal" href="/configuration/environment-variables">
    Override Legendary's config path and log level using shell environment variables.
  </Card>
