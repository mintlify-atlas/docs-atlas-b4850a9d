---
title: "legendary move — Relocate an Installed Epic Game"
sidebarTitle: "Move"
description: "legendary move relocates an installed Epic game to a new base path and updates Legendary's database. Use --skip-move if files were already moved."
---
