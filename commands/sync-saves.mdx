...
description: "Sync cloud saves with Epic using legendary sync-saves. Supports skip, force, save path override, filter disable, and single-app or all-game operation."
---
